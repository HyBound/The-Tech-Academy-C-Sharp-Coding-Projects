...
namespace HogwartsSchool.DAL
{
    public class SchoolInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            {
            new Student{FirstMidName="Carson",LastName="Alexander",EnrollmentDate=DateTime.Parse("2012-09-01")},
            ...
            {
            new Course{CourseID=1050,Title="Potions",Credits=3,},
            new Course{CourseID=4022,Title="DAtDA",Credits=3,},
            new Course{CourseID=4041,Title="Charms",Credits=3,},
            new Course{CourseID=1045,Title="MuggleStudies",Credits=4,},
            new Course{CourseID=3141,Title="Divination",Credits=4,},
            new Course{CourseID=2021,Title="Transfiguration",Credits=3,},
            };
